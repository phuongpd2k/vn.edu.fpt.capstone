...
import vn.edu.fpt.capstone.model.HouseAmenitiesModel;
...
public class HouseAmenitiesServiceImpl implements HouseAmenitiesService {
    ...
    public HouseAmenitiesDto findById(Long id) {
        HouseAmenitiesDto houseAmenitiesDto = modelMapper.map(houseAmenitiesRepository.findById(id).get(), HouseAmenitiesDto.class);
    ...
    public List<HouseAmenitiesDto> findAll() {
        ...
        List<HouseAmenitiesDto> houseAmenitiesDtos = Arrays.asList(modelMapper.map(houseAmenitiesModels, HouseAmenitiesDto[].class));
